...
BEGIN;
INSERT INTO "businesses" (id, name, url, "logoUrl", "cardCode", street1, street2, city, state, zip) VALUES ('1', 'Business 1', 'http://foobar.com', 'http://placekitten.com/500/500', '1234', '123 Foobar St', '#1', 'Austin', 'TX', 78701);
INSERT INTO "businesses" (id, name, url, "logoUrl", "cardCode", street1, street2, city, state, zip) VALUES ('2', 'Business 2', 'http://foobar.com', 'http://placekitten.com/500/500', '1234', '123 Foobar St', '#1', 'Austin', 'TX', 78701);
INSERT INTO "businesses" (id, name, url, "logoUrl", "cardCode", street1, street2, city, state, zip) VALUES ('3', 'Business 3', 'http://foobar.com', 'http://placekitten.com/500/500', '1234', '123 Foobar St', '#1', 'Austin', 'TX', 78701);
COMMIT;
