...
, actions = require('../middleware/actions')
...
function createAppServer() {
  ...
  app.configure(function() {
    ...
    //add actions middleware before logging the requests to the database
    //so we dont duplicate a huge amount of data
    app.use(actions);

    app.use(requestLogger()); // log all requests to the requests table.
