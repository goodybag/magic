...
router.init = function(app){
  ...
  app.post ('/v1/locations',                        fields('locations'), validate.locations.create, routes.v1.locations.create);
  app.get  ('/v1/locations/:locationId',            fields('locations'),                            routes.v1.locations.get);
  app.post ('/v1/locations/:locationId',            fields('locations'), validate.locations.update, routes.v1.locations.update);
  app.put  ('/v1/locations/:locationId',            fields('locations'), validate.locations.update, routes.v1.locations.update);
  app.patch('/v1/locations/:locationId',            fields('locations'), validate.locations.update, routes.v1.locations.update);
