...
Api.prototype.findOne = function($query, options, callback){
  ...
  var query = sql.query('select {fields} from "{collection}" {joins} {where}');
  ...
  // if (options.$join)          getJoin('inner',        options.$leftJoin);
  // if (options.$innerJoin)     getJoin('inner',        options.$leftJoin);
  // if (options.$leftJoin)      getJoin('left',         options.$leftJoin);
  // if (options.$leftOuterJoin) getJoin('left outer',   options.$leftJoin);
  // if (options.$fullOuterJoin) getJoin('full outer',   options.$leftJoin);
  // if (options.$crossJoin)     getJoin('cross outer',  options.$leftJoin);
